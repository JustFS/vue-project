// data
const products = [
  { id: 1, description: 'Brand Designer', price: 28, img: 'assets/img/brand-designer.JPG'},
  ...
  { id: 8, description: "Quarz Luxe", price: 12, img: 'assets/img/quarz-luxe.JPG'},
  ...
  { id: 11, description: 'hiphop-gold', price: 87, img: 'assets/img/hiphop-gold.JPG'},
...
const Home = {
  ...
  computed: {
    ...
    getLikeCookie() {
      let value = JSON.parse($cookies.get('like'));
      value == null ? this.liked = [] : this.liked = value; 
    },
    cartTotal() {     
      let total = 0;
